...
@endif
<form method="GET" action="{{ action('OrderController@cari') }}">
<input type="text" class="form-control" name="keyword" placeholder="Masukkan ID Order">
...
<td><a href="{{action('OrderController@show', $order['idOrder'])}}"
class="btn btn-success">Detail</a></td>
<td><a href="{{action('OrderController@edit', $order['idOrder'])}}"
